...
const routes: Routes = [
  ...
  {
    path: 'blog-grid',
    loadChildren: () => import('./components/pages/bloggrid/bloggrid.module').then(m => m.BloggridModule),
    data: {breadcrumb: 'Blog Grid'}
  },
  {
    path: 'blog-list',
    loadChildren: () => import('./components/pages/bloglist/bloglist.module').then(m => m.BloglistModule),
    data: {breadcrumb: 'Blog List'}
  },
  {
    path: 'blog-masonry',
    loadChildren: () => import('./components/pages/blogmasonry/blogmasonry.module').then(m => m.BlogmasonryModule),
    data: {breadcrumb: 'Blog Masonry'}
  },
  {
    path: 'blog-full-width',
    loadChildren: () => import('./components/pages/blogfull/blogfull.module').then(m => m.BlogfullModule),
    data: {breadcrumb: 'Blog Full Width'}
  },
  {
    path: 'blog-single/:id',
    loadChildren: () => import('./components/pages/blogsingle/blogsingle.module').then(m => m.BlogsingleModule),
  ...
  {
    path: 'menu-v1',
    loadChildren: () => import('./components/pages/menuone/menuone.module').then(m => m.MenuoneModule),
    data: {breadcrumb: 'Menú'}
  },
  {
    path: 'menu-v2',
    loadChildren: () => import('./components/pages/menutwo/menutwo.module').then(m => m.MenutwoModule),
    data: {breadcrumb: 'Menu v2'}
  },
  {
    path: 'menu-item-v1/:id',
    loadChildren: () => import('./components/pages/menuitemone/menuitemone.module').then(m => m.MenuitemoneModule),
    data: {breadcrumb: 'Menu Item v1'}
  },
  {
    path: 'menu-item-v2/:id',
    loadChildren: () => import('./components/pages/menuitemtwo/menuitemtwo.module').then(m => m.MenuitemtwoModule),
    data: {breadcrumb: 'Menu Item v2'}
  },
  {
    path: 'locations',
    loadChildren: () => import('./components/pages/locations/locations.module').then(m => m.LocationsModule),
